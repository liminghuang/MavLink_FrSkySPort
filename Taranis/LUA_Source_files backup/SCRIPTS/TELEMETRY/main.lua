...
------------------------------------------------
local function init()
  loadfile("/SCRIPTS/TELEMETRY/LIBRARY/maininit.lib")(shvars, remfuncs)
  remfuncs.runInit()
  clearTable(remfuncs)
  initRun = true
end
...
------------------------------------------------
    ...
    if req_mainscr then
      if scr_loaded ~= "mainrun" then
        clearTable(remfuncs)
        loadfile("/SCRIPTS/TELEMETRY/LIBRARY/mainrun.lib")(shvars, remfuncs)
        scr_loaded = "mainrun"
      end
      ...
      if scr_loaded ~= "confrun" then
        clearTable(remfuncs)
        loadfile("/SCRIPTS/TELEMETRY/LIBRARY/confrun.lib")(shvars, remfuncs)
        scr_loaded = "confrun"
      end
